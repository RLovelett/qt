...
#ifndef EVENTOPTDLG_H
#define EVENTOPTDLG_H
...
private slots:
    void changeEventDelayState(int state);
    void changeKeyDelayState(int state);
    void changeMouseDelayState(int state);
    void changeKeyEventVB(int state);
    void changeNoCrashHandler(int state);
    void changeEventDelay(QString text);
    void changeKeyDelay(QString text);
    void changeMouseDelay(QString text);
    void saveOpt();
    void closeDlg();
    void showHelp();
