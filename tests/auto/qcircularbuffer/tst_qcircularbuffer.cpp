...
void TestCircularBuffer::initTestCase()
{
}

void TestCircularBuffer::cleanupTestCase()
{
}
...
void TestCircularBuffer::cleanup()
{
}

void TestCircularBuffer::construction()
{
    ...
    QVERIFY( circ4.refCount() == 2 );
    QVERIFY( circ5.refCount() == 2 );
...
void TestCircularBuffer::append()
{
...
void TestCircularBuffer::capacity()
{
    QCircularBuffer<int> circ( 10 );
    QVERIFY( circ.capacity() == 10 );
}

void TestCircularBuffer::clear()
{
    QCircularBuffer<int> circ( 3, 10 );
    QVERIFY( circ.size() == 3 );
    ...
    QVERIFY( circ.size() == 0 );
    QVERIFY( circ.capacity() == 3 );
    QVERIFY( circ.refCount() == 1 );
}

void TestCircularBuffer::contains()
{
...
void TestCircularBuffer::dataOneTwo()
{
...
void TestCircularBuffer::endsWith()
{
...
void TestCircularBuffer::fromList()
{
...
void TestCircularBuffer::fromVector()
{
...
void TestCircularBuffer::indexOf()
{
    QCircularBuffer<int> circ( 5 );
    circ.append( 1 );
    circ.append( 2 );
...
void TestCircularBuffer::insert()
{
    ...
    QVERIFY( circ.capacity() == 8 );
    QVERIFY( circ.size() == 7 );
    QVERIFY( circ.at( 0 ).m_x == 1 );
    QVERIFY( circ.at( 1 ).m_x == 2 );
    QVERIFY( circ.at( 2 ).m_x == 3 );
    QVERIFY( circ.at( 3 ).m_x == 4 );
    QVERIFY( circ.at( 4 ).m_x == 0 );
    QVERIFY( circ.at( 5 ).m_x == 5 );
    QVERIFY( circ.at( 6 ).m_x == 6 );
    ...
    QVERIFY( circ2.at( 0 ).m_x == 0 );
    QVERIFY( circ2.at( 1 ).m_x == 0 );
    QVERIFY( circ2.at( 2 ).m_x == 0 );
    QVERIFY( circ2.at( 3 ).m_x == 0 );
    QVERIFY( circ2.at( 4 ).m_x == 0 );
    QVERIFY( circ2.at( 5 ).m_x == 0 );
    QVERIFY( circ2.at( 6 ).m_x == 5 );
    QVERIFY( circ2.at( 7 ).m_x == 6 );
    ...
    QVERIFY( circ7.at( 0 ).m_x == 1 );
    QVERIFY( circ7.at( 1 ).m_x == 0 );
    QVERIFY( circ7.at( 2 ).m_x == 2 );
    QVERIFY( circ7.at( 3 ).m_x == 3 );
    QVERIFY( circ7.at( 4 ).m_x == 4 );
    QVERIFY( circ7.at( 5 ).m_x == 5 );
    QVERIFY( circ7.at( 6 ).m_x == 6 );
    ...
    QVERIFY( circ8.at( 0 ).m_x == 0 );
    QVERIFY( circ8.at( 1 ).m_x == 0 );
    QVERIFY( circ8.at( 2 ).m_x == 0 );
    QVERIFY( circ8.at( 3 ).m_x == 2 );
    QVERIFY( circ8.at( 4 ).m_x == 3 );
    QVERIFY( circ8.at( 5 ).m_x == 4 );
    QVERIFY( circ8.at( 6 ).m_x == 5 );
    QVERIFY( circ8.at( 7 ).m_x == 6 );
    ...
    for ( int i = 0; i < circ13.size(); ++i )
    {
        ...
        if ( i < 5 )
            ...
            QVERIFY( circ13.at( i ).m_x == ( i + 1 ) * 10 );
    }
    ...
    for ( int i = 0; i < circ19.size(); ++i )
    {
        ...
        if ( i < 5 )
            ...
            QVERIFY( circ19.at( i ).m_x == 10 );
    }
}

void TestCircularBuffer::insertIterator()
{
...
void TestCircularBuffer::isEmpty()
{
    QCircularBuffer<int> circ( 3 );
...
void TestCircularBuffer::isFull()
{
    QCircularBuffer<int> circ( 3 );
...
void TestCircularBuffer::isLinearised()
{
    QCircularBuffer<int> circ( 3 );
    QVERIFY( circ.isLinearised() == true );
    circ.append( 1 );
...
void TestCircularBuffer::lastIndexOf()
{
    QCircularBuffer<int> circ( 5 );
    circ.append( 1 );
    circ.append( 2 );
...
void TestCircularBuffer::linearise()
{
...
void TestCircularBuffer::prepend()
{
    // Create a circular buffer with capacity for 3 items
    QCircularBuffer<int> circ( 3 );
...
void TestCircularBuffer::removeStaticLinearised()
{
    ...
    QVERIFY( circ.at( 1 ).m_x == 2 );
    QVERIFY( circ.at( 2 ).m_x == 3 );
    QVERIFY( circ.at( 3 ).m_x == 5 );
    QVERIFY( circ.at( 4 ).m_x == 6 );
    ...
    QVERIFY( circ.size() == 4 );
    QVERIFY( circ.at( 0 ).m_x == 1 );
    QVERIFY( circ.at( 1 ).m_x == 4 );
    QVERIFY( circ.at( 2 ).m_x == 5 );
    QVERIFY( circ.at( 3 ).m_x == 6 );
...
void TestCircularBuffer::removeStaticNonLinearised()
{
    ...
    QVERIFY( circ.capacity() == 10 );
    QVERIFY( circ.size() == 8 );
    QVERIFY( circ.at( 0 ).m_x == 6 );
    QVERIFY( circ.at( 1 ).m_x == 7 );
    QVERIFY( circ.at( 2 ).m_x == 8 );
    QVERIFY( circ.at( 3 ).m_x == 9 );
    QVERIFY( circ.at( 4 ).m_x == 10 );
    QVERIFY( circ.at( 5 ).m_x == 11 );
    QVERIFY( circ.at( 6 ).m_x == 12 );
    QVERIFY( circ.at( 7 ).m_x == 13 );
    ...
    QVERIFY( circ.size() == 6 );
    QVERIFY( circ.at( 0 ).m_x == 6 );
    QVERIFY( circ.at( 1 ).m_x == 11 );
    QVERIFY( circ.at( 2 ).m_x == 12 );
    QVERIFY( circ.at( 3 ).m_x == 13 );
    QVERIFY( circ.at( 4 ).m_x == 14 );
    QVERIFY( circ.at( 5 ).m_x == 15 );
    ...
    QVERIFY( circ2.at( 0 ).m_x == 3 );
    QVERIFY( circ2.at( 1 ).m_x == 4 );
    ...
    QVERIFY( circ3.at( 0 ).m_x == 3 );
    QVERIFY( circ3.at( 1 ).m_x == 4 );
    QVERIFY( circ3.at( 2 ).m_x == 5 );
    QVERIFY( circ3.at( 3 ).m_x == 8 );
    ...
    QVERIFY( circ4.at( 0 ).m_x == 3 );
    QVERIFY( circ4.at( 1 ).m_x == 6 );
    QVERIFY( circ4.at( 2 ).m_x == 7 );
    QVERIFY( circ4.at( 3 ).m_x == 8 );
}

void TestCircularBuffer::removeMovableLinearised()
{
...
void TestCircularBuffer::removeMovableNonLinearisedUpper()
{
...
void TestCircularBuffer::removeMovableNonLinearisedLower()
{
    // Src region wraps and the dst region does not wrap.
...
void TestCircularBuffer::replace()
{
...
void TestCircularBuffer::resize()
{
    QCircularBuffer<int> circ( 10 );
    for ( int i = 0; i < circ.capacity(); ++i )
        circ.append( i + 1 );
...
void TestCircularBuffer::setCapacityStatic()
{
    ...
    for ( int i = 0; i < circ3.size(); ++i )
        QVERIFY( circ3.at( i ).m_x == i + 17 );
}

void TestCircularBuffer::setCapacityMovable()
{
    // New capacity < old capacity & src region wraps
    QCircularBuffer<int> circ( 20 );
    for ( int i = 0; i < 36; ++i )
...
void TestCircularBuffer::sizeAvailable()
{
    QCircularBuffer<int> circ( 10 );
    QVERIFY( circ.capacity() == 10 );
    QVERIFY( circ.size() == 0 );
...
void TestCircularBuffer::startsWith()
{
    // Test with a linearised buffer
    QCircularBuffer<int> circ( 5 );
    circ.append( 1 );
...
void TestCircularBuffer::toList()
{
    QCircularBuffer<int> circ( 10 );
    for ( int i = 0; i < circ.capacity(); ++i )
        circ.append( i + 1 );
...
void TestCircularBuffer::toVector()
{
    QCircularBuffer<int> circ( 10 );
    for ( int i = 0; i < circ.capacity(); ++i )
        circ.append( i + 1 );
...
void TestCircularBuffer::operatorEquality()
{
...
void TestCircularBuffer::operatorInequality()
{
    QCircularBuffer<int> circ1( 10 );
...
void TestCircularBuffer::operatorPlus()
{
...
void TestCircularBuffer::operatorPlusEquals()
{
...
void TestCircularBuffer::operatorStream()
{
    QCircularBuffer<int> circ( 100 );
    for ( int i = 0; i < 10; ++i )
        circ.append( i + 1 );
...
void TestCircularBuffer::const_iterator()
{
    ...
    for ( int i = 0; i < circ2.capacity(); ++i )
    {
        QVERIFY( it6->m_x == circ3.at( i ).m_x );
        ++it6;
    }
}

void TestCircularBuffer::iterator()
{
    // Test basic iteration over a linearised buffer.
    // This tests operators !=, prefix ++, and *
    QCircularBuffer<int> circ( 10 );
