...
void tst_QPainter::drawBorderPixmap()
{
    ...
    }
    {
        ...
        p.translate(100, 100);
        qDrawBorderPixmap(&p,  QRect(0, 0, 79, 79), QMargins(8, 8, 8, 8), src, QRect(0, 0, 79, 79), QMargins(8, 8, 8, 8),
    ...
    QVERIFY(resImage.pixel(179, 100) == origImage.pixel(179, 100));
    QVERIFY(resImage.pixel(100, 179) == origImage.pixel(100, 179));
    QVERIFY(resImage.pixel(179, 179) == origImage.pixel(179, 179));
