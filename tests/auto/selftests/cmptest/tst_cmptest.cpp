...
private slots:
    ...
    void qfuzzy_compare_int();
    void qfuzzy_compare_int_data();
    void qfuzzy_compare_float();
    void qfuzzy_compare_float_data();
    void qfuzzy_compare_char();
    void qfuzzy_compare_char_data();
};
...
//for testing the int versions of a QFUZZY_COMPARE.
void tst_Cmptest::qfuzzy_compare_int()
{
  QFETCH(int, expected);
  QFETCH(int, comparison);
  QFETCH(int, fuzz);

  QFUZZY_COMPARE(expected, comparison, fuzz);
}

void tst_Cmptest::qfuzzy_compare_int_data()
{
...
//for testing the float versions of a QFUZZY_COMPARE.
void tst_Cmptest::qfuzzy_compare_float()
{
...
void tst_Cmptest::qfuzzy_compare_float_data()
{
...
//for testing the char versions of a QFUZZY_COMPARE.
void tst_Cmptest::qfuzzy_compare_char()
{
...
void tst_Cmptest::qfuzzy_compare_char_data()
{
