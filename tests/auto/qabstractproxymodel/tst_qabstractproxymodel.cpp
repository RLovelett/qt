...
#if 0
    AnotherStandardItemModelWithCustomRoleNames model2;
    QHash<int, QByteArray> model2RoleNames = model2.roleNames();

    proxy1.setSourceModel(&model2);
    proxy1RoleNames = proxy1.roleNames();
    proxy2RoleNames = proxy2.roleNames();

    verifySubSetOf( proxy1RoleNames, defaultModelRoleNames );
    QVERIFY( proxy1RoleNames.size() == defaultModelRoleNames.size() + 2 );
    QVERIFY( proxy1RoleNames.contains(AnotherStandardItemModelWithCustomRoleNames::AnotherCustomRole1));
    QVERIFY( proxy1RoleNames.contains(AnotherStandardItemModelWithCustomRoleNames::AnotherCustomRole2));
    QVERIFY( proxy1RoleNames.value(AnotherStandardItemModelWithCustomRoleNames::AnotherCustomRole1) == "another_custom1" );
    QVERIFY( proxy1RoleNames.value(AnotherStandardItemModelWithCustomRoleNames::AnotherCustomRole2) == "another_custom2" );

    verifySubSetOf( proxy2RoleNames, defaultModelRoleNames );
    QVERIFY( proxy2RoleNames.size() == defaultModelRoleNames.size() + 2 );
    QVERIFY( proxy2RoleNames.contains(AnotherStandardItemModelWithCustomRoleNames::AnotherCustomRole1));
    QVERIFY( proxy2RoleNames.contains(AnotherStandardItemModelWithCustomRoleNames::AnotherCustomRole2));
    QVERIFY( proxy2RoleNames.value(AnotherStandardItemModelWithCustomRoleNames::AnotherCustomRole1) == "another_custom1" );
    QVERIFY( proxy2RoleNames.value(AnotherStandardItemModelWithCustomRoleNames::AnotherCustomRole2) == "another_custom2" );


    proxy1.setSourceModel(0);
    QVERIFY(proxy1.roleNames() == defaultModelRoleNames);
    QVERIFY(proxy2.roleNames() == defaultModelRoleNames);
#endif
}
