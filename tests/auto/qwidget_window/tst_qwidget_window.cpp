...
void tst_QWidget_window::tst_showGeometry()
{
    ...
    // geometry from Qt
    QVERIFY2(pp1.fx == 0 && pp1.fy == 0, "position for +0+0");
    pp2.parse(p[1]);
    ...
    pp2.parse(p[2]);
    QVERIFY2(pp2.fx == 0 && pp2.fy == 0, "position for 320x240+0+0");
    QVERIFY2(pp2.ww == 320 && pp2.wh == 240, "size for 320x240+0+0");

    pp2.parse(p[3]);
    QVERIFY2(pp2.fy == 0 && pp2.fx + pp2.fw == avail.width(),
        "top right 320x240-0+0");
    pp2.parse(p[4]);
    QVERIFY2(pp2.fy + pp2.fh == avail.height() && pp2.fx == 0,
        "bottom left 320x240+0-0");
    pp2.parse(p[5]);
    QVERIFY2(pp2.fy + pp2.fh == avail.height() &&
        pp2.fx + pp2.fw == avail.width(), "bottom right 320x240-0-0");

    pp2.parse(p[6]);
    QVERIFY2(pp2.fx == 10 && pp2.fy == 10, "position for 320x240+10+10");
    QVERIFY2(pp2.ww == 320 && pp2.wh == 240, "size for 320x240+10+10");

    pp2.parse(p[7]);
    QVERIFY2(pp2.fy == 10 && pp2.fx + pp2.fw == avail.width() - 10,
        "top right 320x240-10+10");
    pp2.parse(p[8]);
    QVERIFY2(pp2.fy + pp2.fh == avail.height() - 10 && pp2.fx == 10,
        "bottom left 320x240+10-10");
    pp2.parse(p[9]);
    QVERIFY2(pp2.fy + pp2.fh == avail.height() - 10 &&
        pp2.fx + pp2.fw == avail.width() - 10, "bottom right 320x240-10-10");
