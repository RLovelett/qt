...
DEFINEFUNC5(int, EVP_CipherInit, EVP_CIPHER_CTX *a, a, const EVP_CIPHER *b, b, unsigned char *c, c, unsigned char *d, d, int e, e, return 0, return)
DEFINEFUNC5(int, EVP_CipherUpdate, EVP_CIPHER_CTX *a, a, unsigned char *b, b, int *c, c, unsigned char *d, d, int e, e, return 0, return)
DEFINEFUNC3(int, EVP_CipherFinal, EVP_CIPHER_CTX *a, a, unsigned char *b, b, int *c, c, return 0, return)
DEFINEFUNC2(int, EVP_CIPHER_CTX_set_padding, EVP_CIPHER_CTX *a, a, int b, b, return 1, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_get_cipherbyname, const char *a, a, return 0, return)
...
bool q_resolveOpenSslSymbols()
{
    ...
    RESOLVEFUNC(EVP_get_cipherbyname)
