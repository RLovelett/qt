...
void QVGPaintEnginePrivate::initObjects()
{
    ...
    const char *extensions = (char *) vgGetString(VG_EXTENSIONS);

    if (extensions) {
        if (strstr(extensions, "VG_KHR_advanced_blending")) {
            hasAdvancedBlending = true;
        } else {
...
void QVGPaintEngine::compositionModeChanged()
{
    ...
    default:
        if (d->hasAdvancedBlending) {
            ...
            qWarning() << "VG_KHR_advanced_blending not supported";
        }
