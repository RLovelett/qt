...
static const struct {
    ...
    { DMPAPER_B4,                 QPrinter::JIS_B4 },
    { DMPAPER_B5,                 QPrinter::JIS_B5 },
    { DMPAPER_FOLIO,              QPrinter::Folio },
    { DMPAPER_ENV_10,             QPrinter::Comm10E },
    { DMPAPER_ENV_DL,             QPrinter::DLE },
    { DMPAPER_ENV_C3,             QPrinter::C5E },
    { DMPAPER_ENV_B4,             QPrinter::B4 },
    { DMPAPER_ENV_B5,             QPrinter::B5 },
    { DMPAPER_ISO_B4,             QPrinter::B4 },
    ...
    { DMPAPER_B5_TRANSVERSE,      QPrinter::JIS_B5 },
    ...
    { DMPAPER_A6,                 QPrinter::A6 },
    { DMPAPER_B6_JIS,             QPrinter::JIS_B6 },
    { DMPAPER_PENV_3,             QPrinter::B6 },
    { DMPAPER_PENV_5,             QPrinter::DLE },
    { 0, QPrinter::Custom }
};
