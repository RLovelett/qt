...
static const char * const psToStr[QPrinter::NPaperSize+1] =
{
    ...
    "DLE", "Folio", "Ledger", "Tabloid", "JIS_B0", "JIS_B1", "JIS_B2",
    "JIS_B3", "JIS_B4", "JIS_B5", "JIS_B6", "JIS_B7", "JIS_B8", "JIS_B9",
    "JIS_B10", "JIS_B11", "JIS_B12", "JIS_Shiban4", "JIS_Shiban5",
    "JIS_Shiban6", "JIS_Kiku4", "JIS_Kiku5", 0
};
